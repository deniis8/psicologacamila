...
export function Perguntas() {
    return (
        <main>
            ...
            <div>
                <br /><br /><br /><br />
                <h1 className={style.h1}>Como funciona a primeira sessão de psicoterapia?</h1>
                ...
                <br />
                <h1 className={style.h1}>Qual é a diferença entre atendimento psicológico para adultos e para crianças?</h1>
                ...
                <br />
                <h1 className={style.h1}>Quanto tempo leva, em média, para perceber resultados na terapia?</h1>
                ...
                <br />
                <h1 className={style.h1}>O que devo esperar do processo terapêutico?</h1>
                ...
                <br />
                <h1 className={style.h1}>O psicólogo pode prescrever remédios?</h1>
                ...
                <br />
                <h1 className={style.h1}>Como funciona a psicoterapia infantil? Os pais participam das sessões?</h1>
                ...
                <br />
                <h1 className={style.h1}>As sessões são sigilosas?</h1>
                ...
                <br />
                <h1 className={style.h1}>Atende online e presencial? Como funciona cada formato?</h1>
